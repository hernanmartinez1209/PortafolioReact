        ...
        <div className='Hedaer'>
            ...
            <article className='box__info-header'>
                    <ul className='inf__Header'>
                        <li className='links__header'><a href="hernanconce1213@gmail.com"><i className="icon_header fa-solid fa-inbox"></i></a></li>
                        <li className='links__header'><a href="https://wa.me/+50497354802"><i className="icon_header fa-brands fa-whatsapp"></i></a></li>
                        <li className='links__header'><i className="icon_header fa-solid fa-location-dot"></i></li>
                    </ul>
            </article>
        </div>
    )
